...
// Menu latéral (identique desktop / mobile). Le rôle Commercial voit tout sauf
// le catalogue Articles, réservé au Responsable (admin).
const NAV_ITEMS = [
  { to: '/', key: 'nav.dashboard', icon: 'M3 12l9-8 9 8M5 10v10h5v-6h4v6h5V10', adminOnly: false },
  { to: '/devis', key: 'nav.devis', icon: 'M7 3h7l5 5v13H5V5a2 2 0 012-2zm7 0v5h5M8 13h8M8 17h5', adminOnly: false },
  { to: '/paiements', key: 'nav.payments', icon: 'M3 7h18v10a2 2 0 01-2 2H5a2 2 0 01-2-2V7zm0 4h18M7 15h4', adminOnly: false },
  { to: '/articles', key: 'nav.articles', icon: 'M4 6h16M4 12h16M4 18h10M18 16l2 2 3-3', adminOnly: true },
  { to: '/profil', key: 'nav.profile', icon: 'M12 12a4 4 0 100-8 4 4 0 000 8zm-7 8a7 7 0 0114 0', adminOnly: false },
