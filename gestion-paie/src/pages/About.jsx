...
export default function About() {
  ...
  const formulas = [
    ...
    ['Cotisations salariales', 'Retraite CNPS 6,3 % (assiette plafonnée) + CMU 500 FCFA par personne couverte (part salariale du forfait de 1 000 FCFA/personne) — le salarié + ses enfants à charge.'],
    ['Charges patronales', 'Retraite 7,7 %, prestations familiales 5,75 % et accident du travail 2–5 % (assiette plafonnée à 75 000), IS local 1,2 % (ou 11,5 % pour un expatrié), taxe d’apprentissage 0,4 %, FPC 0,6 %, CMU 500 FCFA par personne couverte (salarié + enfants à charge).'],
